...
start_x = SCREEN_WIDTH - square_size
start_y = 0
...
def update_green_square_position():
    ...
    if green_square_y <= 260:
        green_square_y = 260
        green_square_direction = 1  # Move down
    elif green_square_y >= (SCREEN_HEIGHT - square_size *4)-100:  # Considering the green square's height
        green_square_y = (SCREEN_HEIGHT - square_size *4)-100
    ...
    for row_index, row in enumerate(level_data):
        for col_index, cell in enumerate(row):
            ...
            if cell == "g":  # Draw the green square
                pygame.draw.rect(screen, GREEN, (col_index * square_size, green_square_y, square_size*4, square_size*4))  # Use green_square_y for vertical position
        ...
        for col_index, cell in enumerate(row):
            if cell == "g":
                ...
                green_square_rect = pygame.Rect(
                    ...
                    square_size * 4,  # Adjust width to match the green square's width
                    square_size * 4   # Adjust height to match the green square's height
                )
...
while True:
    ...
    level_data = load_level('level_data3.csv')  # Make sure this CSV file exists in the directory
