...
def update_green_square_position():
    ...
    elif green_square_y >= SCREEN_HEIGHT - square_size * 6:  # Considering the green square's height
        green_square_y = SCREEN_HEIGHT - square_size * 6
    ...
    for row_index, row in enumerate(level_data):
        for col_index, cell in enumerate(row):
            ...
            if cell == "g":  # Draw the green square
                pygame.draw.rect(screen, GREEN, (col_index * square_size, green_square_y, square_size*8, square_size*6))  # Use green_square_y for vertical position
...
while True:
    ...
    level_data = load_level('level_data2.csv')  # Make sure this CSV file exists in the directory
